    ...
    return (
        <div className={fadeToggle === false ? 'no-science' : 'science-component'}>
            <Helmet>
                ...
                <meta name='description' content='Want to know more about the science of solar? Elevate Solar Energy provides everything for individuals who want to know more about the power of solar.' />
            </Helmet>
            <div className='science-steps-section'>
                ...
                <div className='science-steps'>
                    <p className='science-steps-description'>The graphic below gives you a basic idea of how solar power systems work:</p>
                    <div className='align-all-steps'>
                        ...
                        <div className='science-align-bottom-steps'>
                            <div className='science-step-phone'>
                                <nav>
                                    <p id='science-step-subtitles'>1. Solar Panels</p>
                                    <p>Turn sunlight into direct current (DC) electricity.</p>
                                </nav>
            ...
            <div className='science-sun-section'>
            ...
            <div id='hr-border'></div>
            <div className='science-eco-section'>
            ...
            <div id='hr-border'></div>
            <div className='science-direct-section'>
