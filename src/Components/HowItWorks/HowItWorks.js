    ...
    return( 
        <div className='works-component'>
            <div className='works-top-section'>
                ...
                <nav>
                    <p>As a Customer you will receive: </p>
                    <ul>
                ...
                <p>If you decide to sell your house before the solar contract is finished, thats fine. The new homeowner would just assume the Elevate contract until it is fulfilled.</p>
            </div>
            <hr></hr>
            <div className='works-bottom-section'>
                <p>WHAT'S THE REAL CATCH?</p>
                ...
                <p>GOING GREEN HAS NEVER BEEN MORE ATTRACTIVE AND PROFITABLE!</p>
